...
(() => {
	...
	filterContainer.addEventListener("click", (event) => {
		if (event.target.classList.contains("filter-item") &&
			...
			filterContainer.querySelector(".active").classList.remove("inner-shadow", "active");
	...
	portfolioItemsContainer.addEventListener("click", (event) => {
		if (event.target.closest(".portfolio-item-inner")) {
			...
			itemIndex = Array.from(portfolioItem.parentElement.children).indexOf(
				portfolioItem);
			console.log(portfolioItems[itemIndex].querySelector(".portfolio-item-img img").getAttribute("data-screenshot"))
	...
	function popupSlideshow() {
		console.log('calling slide show', slideIndex)
		...
		popup.querySelector(".pp-counter").innerHTML = (slideIndex + 1) + " of " + (screenshots.length - 1);
	}
	//next slide
